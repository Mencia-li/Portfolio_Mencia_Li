<template>
    <section class="min-h-screen flex items-center justify-center theme-base">
        ...
        <div class="flex flex-col justify-center items-center md:items-start text-center md:text-left space-y-8 order-2 md:order-2 md:pl-20">
            ...
            <div class="space-y-4">
            <p class="hero-text text-xl leading-relaxed">
            ...
            <button @click="goToAbout" class="theme-invert btn-primary text-lg px-8 py-4 rounded-md font-semibold hover:opacity-90 transition-all cursor-pointer active:scale-95">
                ¡Cuéntame más!
            </button>
            </div>
        </div>
...
// Función para navegar manualmente desde los puntos
const scrollTo = (index: number) => {
    carouselApi.value?.scrollTo(index)
}

// Sincronizar el estado del punto activo con el carrusel
